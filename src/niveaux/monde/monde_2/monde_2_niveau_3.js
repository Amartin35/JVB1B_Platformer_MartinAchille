...
export default class MONDE_2_NIVEAU_3 extends Phaser.Scene{
	constructor() {
		super({key : "MONDE_2_NIVEAU_3"}); // mettre le meme nom que le nom de la classe
	}
	
	
	/////////////////////////////////////// CREATE ///////////////////////////////////////
	create(){
		const map = this.add.tilemap("map_monde_2_niveau_3");
		...
		this.physics.add.collider(this.player, finLayer, () => {
			this.scene.start("MONDE_2_NIVEAU_4",{
			});
