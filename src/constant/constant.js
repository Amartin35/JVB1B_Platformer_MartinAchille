...
const BARRIERE_LAYER_DEPTH = 90
const PLAYER_LAYER_DEPTH = 80
const BOSS_LAYER_DEPTH = 70
const TWEEN_MOUVEMENT = 65
const LASER_LAYER_DEPTH = 62
const REPOSE_TWEEN_LAYER_DEPTH = 60
const FIN_LAYER_DEPTH = 55
const ACIDE_LAYER_DEPTH = 45
const SOLIDE_LAYER_DEPTH = 40
const OBSTACLE_LAYER_DEPTH = 38
const PROPS_LAYER_DEPTH = 35
